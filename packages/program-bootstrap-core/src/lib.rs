...
use hooks::{communication::InterProcessComClient, InjectOptions, InjectOptionsWrapper};
use log::{info, LevelFilter};
use simple_logger::SimpleLogger;

#[no_mangle]
pub unsafe extern "system" fn enable_hook(opts_ptr: *const InjectOptionsWrapper) {
